...
summary: You have questions? Woah! I have questions too...
tags:
  - Misc
draft: false
authors:
...
**TLDR:** I'd like your help designing and perhaps co-patenting what you coined the [infinite canvas](https://www.scottmccloud.com/4-inventions/canvas/index.html).
I'm working on the tech that makes that possible right now. A 3d navigation engine called *Harmony*.

Even if you are not Scott yourself, I'm sure you'll find this letter (more like an essay, smh) very interesting. At the Guild of Artists, everything we do is shared with our community in the interest of transparency.
...
Not yet! I'm Marc, a 23 yo Bachelor of Arts in Computer Science with a specialization in business and accounting.
...
There is a lowly word executives in the tech industry like to throw around a lot. Rather that call a piece of artwork by what it really is, they refer to it as "user-generated content." As far as their algorithms are concerned, it's face value is only the revenue it generates. Blech!

Traditionally all apps force you to upload user-generated content in limitting ways; including in limiting layouts, quantity, format etc. It make sense, since their platforms are designed to pit these individual nuggets of content against each other for real estate on precious user feeds. They force artists to make serious compromizes when sharing their work, placing bets on which piece of content in their catalogue will gain the most traction.

<Copyright to="Copyright Scott McCloud, 2000 - Reinventing Comics page 77">

![Illustration from a comic by Scott McCloud featuring a greedy, overgrown, self-eating, snake-like dollar sign](/static/images/blog/reinventing-comics-by-scott-mccloud/p77.jpg)

</Copyright>

The corperations who build such software do so with the intent of generating money, often by collecting and re-selling user data, showing ads and taking fees from merchants. If artists could show their art how they wanted, where could a company efficiently squeeze in an advertisement? God forbid a user actually like a creator's content so much that they leave the app to go support the artist directly! Oh no, my precious bottom line has been ruined!

One of the earliest requests from the artists I came in contact with was to remove these creative restrictions. Artists want to share not just one image, or video, or text, but several pieces of information together as a single, cohesive unit.

<Copyright to="Copyright Scott McCloud, 2000 - Reinventing Comics page 215">

![Exerpt from a comic by Scott McCloud that reads "While in the temporal map of comics, every element of the work has a spacial relationship to every other element at all times. To break a comic down into a single picture is to tear that map to shreds and with it the very fabric of comics' core identity."](/static/images/blog/reinventing-comics-by-scott-mccloud/p215-2.jpg)
...
Watch my recorded video below for more details, or visit the [whats.guild.art](https://whats.guild.art) on a device with a large screen for access to a 3d presentation that demonstrates and explains how the marketplace will work.
...
Secondly, I'd like to address a minor fear of mine when it comes to legal rights. I want what I'm making to be a tool exclusive for professional artists within our network. My hopes for a patent are to show we're serious, lend credibility to what we're building and defend ourselves if necessary. A patent is hardly a necessity, but a provision. No idea is worth anything without good execution, and we're still a long ways from that. The real work is building a community and a helpful tool for artists to make a living. My offer for a co-patent is serious, but it requires time and money from both parties involved; so it's up to you whether it becomes a reality soon, as I don't plan on filing for a patent on my own for a while. I remain hopeful, but I don't expect a yes.
...
Your comic was invaluable in that it helped me re-think several flawed aspects of my approach at solving the harmony renderer, among several other problems. I'm really glad I found it. Thank you for writing it!
