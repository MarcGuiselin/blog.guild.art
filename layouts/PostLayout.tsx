    ...
    <SectionContainer>
      ...
      <article>
        <div className="xl:divide-y xl:divide-gray-200 xl:dark:divide-onyx-700">
          ...
          <div
            className="pb-8 divide-y divide-gray-200 xl:divide-y-0 dark:divide-onyx-700 xl:grid xl:grid-cols-4 xl:gap-x-6"
            style={{ gridTemplateRows: 'auto 1fr' }}
          >
            <dl className="pt-6 pb-10 xl:pt-11 xl:border-b xl:border-gray-200 xl:dark:border-onyx-700">
            ...
            <footer>
              <div className="text-sm font-medium leading-5 divide-gray-200 xl:divide-y dark:divide-onyx-700 xl:col-start-1 xl:row-start-2">
                {tags && (
